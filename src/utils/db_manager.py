...
class DBManager:
    def __init__(
        ...
        facilities_repo_cls: Type,
        rooms_facilities_repo_cls: Type,
    ):
    ...
    async def __aenter__(self):
        ...
        self.facilities = self.facilities_repo_cls(self.session)
        self.rooms_facilities = self.rooms_facility_repo_cls(self.session)
        return self
